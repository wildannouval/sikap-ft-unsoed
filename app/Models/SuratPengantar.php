...
class SuratPengantar extends Model
{
    protected $fillable = [
        ...
        'tanggal_disetujui_surat_pengantar','tanggal_terbit_surat_pengantar',
        'tanggal_pengambilan_surat_pengantar','catatan_surat','qr_token',
        'qr_expires_at','ttd_signed_at','ttd_signed_by'
    ];

    protected $casts = [
        'tanggal_pengajuan_surat_pengantar'   => 'date',
        'tanggal_disetujui_surat_pengantar'   => 'date',
        'tanggal_terbit_surat_pengantar'      => 'date',
        'tanggal_pengambilan_surat_pengantar' => 'date',
