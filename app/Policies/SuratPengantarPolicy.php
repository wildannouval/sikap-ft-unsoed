...
class SuratPengantarPolicy
{
    ...
    {
        return $user->mahasiswa && $user->mahasiswa->id === $suratPengantar->mahasiswa_id;
    }
    ...
    public function export(User $user, SuratPengantar $sp): bool
    {
        return $this->view($user, $sp) && $sp->status_surat_pengantar === 'Terbit';
    }
}
