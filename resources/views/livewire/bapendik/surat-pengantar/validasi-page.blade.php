        ...
        <div class="flex items-start gap-2 px-1.5 -mt-1">
            ...
            <div>
                ...
                <div class="mt-1 text-sm text-zinc-600 dark:text-zinc-300 space-y-1.5">
                    <div><span class="font-medium">1)</span> Gunakan tab <strong>Belum Diterbitkan</strong> untuk
                        memproses pengajuan baru.</div>
                    <div><span class="font-medium">2)</span> Klik <strong>Terbitkan</strong> untuk memberi nomor &
                        penandatangan; atau <strong>Tolak</strong> dengan catatan.</div>
                    <div><span class="font-medium">3)</span> Riwayat <strong>Sudah Diterbitkan</strong> dapat diunduh
                        (DOCX) atau diubah nomor bila perlu.</div>
                    <div><span class="font-medium">4)</span> Pencarian dapat dilakukan berdasarkan perusahaan, penerima,
                        nomor, nama/NIM.</div>
                </div>
            </div>
        </div>
                    ...
                    <flux:table
                        ...
                        <flux:table.columns>
                            ...
                            <flux:table.column sortable :sorted="$sortBy === 'tanggal_disetujui_surat_pengantar'"
                                :direction="$sortDirection" wire:click="sort('tanggal_disetujui_surat_pengantar')">
                                Tgl Terbit
                            </flux:table.column>
                            <flux:table.column>Mahasiswa</flux:table.column>
