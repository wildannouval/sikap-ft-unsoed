<div class="space-y-6">
    ...
    {{-- PANDUAN (aksen violet, selaras dashboard) --}}
    <flux:card
        ...
        <div class="flex items-start gap-2 px-1.5 -mt-1">
            ...
            <div>
                ...
                <div class="mt-1 text-sm text-zinc-600 dark:text-zinc-300 space-y-1.5">
                    <div><span class="font-medium">1)</span> Gunakan kolom <em>cari</em> & filter status untuk menyaring
                        data.</div>
                    <div><span class="font-medium">2)</span> Tetapkan <strong>Dosen Pembimbing</strong> pada pengajuan
                        status <em>Menunggu Review Komisi</em>.</div>
                    <div><span class="font-medium">3)</span> Klik <strong>Setujui</strong> untuk meneruskan ke Bapendik
                        (SPK), atau <strong>Tolak</strong> dengan catatan.</div>
                    <div><span class="font-medium">4)</span> Setelah <em>SPK Terbit</em>, Komisi dapat mengunduh dokumen
                        SPK.</div>
                </div>
            </div>
        </div>
                        ...
                        <div
                            ...
                            <flux:table
                                ...
                                <flux:table.columns>
                                    ...
                                    <flux:table.column sortable :sorted="$sortBy === 'status'"
                                        :direction="$sortDirection" wire:click="sort('status')">
                                        Status
                                    </flux:table.column>
                                            ...
                                            <flux:table.cell>
                                                ...
                                                <flux:dropdown position="bottom" align="end">
                                                    ...
                                                    <flux:menu class="min-w-48">
                                                        ...
                                                        @else
                                                            <flux:menu.item icon="check" disabled>Setujui
                                                            </flux:menu.item>
                                                        @endif
                                                        ...
                                                        @else
                                                            <flux:menu.item icon="x-mark" disabled>Tolak
                                                            </flux:menu.item>
                                                        @endif

                                                        {{-- Unduh SPK (hanya saat sudah terbit) --}}
                        ...
                        <div class="p-4 space-y-3">
                            <div class="flex items-start justify-between gap-3">
                                <div class="flex items-center gap-2">
                                    <flux:badge size="sm" inset="top bottom"
                                        :color="$this->badgeColor('review_komisi')">
                            ...
                            <div class="flex items-start justify-between gap-3">
                                <div class="flex items-center gap-2">
                                    <flux:badge size="sm" inset="top bottom"
                                        :color="$this->badgeColor('spk_terbit')">
                                        SPK Terbit
                                    </flux:badge>
                                </div>
                                <span class="font-semibold text-stone-900 dark:text-stone-100">
                            ...
                            <div class="space-y-2 text-sm text-zinc-600 dark:text-zinc-300">
                                <div>
                                    ...
                                    Ajukan oleh mahasiswa; komisi dapat memilih pembimbing, meninjau berkas,
                                    lalu setujui/tolak.
                                </div>
                                <div>
    ...
    <flux:modal name="reject-kp" class="min-w-[26rem]">
        <div class="space-y-6">
            <div>
                ...
                <flux:text class="mt-2">Masukkan catatan penolakan untuk mahasiswa.</flux:text>
            </div>
